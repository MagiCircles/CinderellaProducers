    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('i_play_with', models.PositiveIntegerField(null=True, verbose_name='Play with', choices=[(0, 'Thumbs'), (1, 'All fingers'), (2, 'Index fingers'), (3, 'One hand'), (4, 'Other')])),
                ...
                ('i_producer_rank', models.PositiveIntegerField(default=0, verbose_name='Producer Rank', choices=[(0, b'E'), (1, b'D'), (2, b'C'), (3, b'B'), (4, b'A'), (5, b'S'), (6, b'SS')])),
                ...
                ('_cache_center_card_i_type', models.PositiveIntegerField(null=True, choices=[(0, 'Cute'), (1, 'Cool'), (2, 'Passion')])),
                ('_cache_center_card_icon', models.ImageField(null=True, upload_to=cpro.models.uploadItem(b'c/icon'))),
                ('_cache_center_card_art', models.ImageField(null=True, upload_to=cpro.models.uploadItem(b'c/art'))),
                ('_cache_center_card_transparent', models.ImageField(null=True, upload_to=cpro.models.uploadItem(b'c/transparent'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_bonded', models.BooleanField(default=False, verbose_name='Max Bonded')),
                ('max_leveled', models.BooleanField(default=False, verbose_name='Max Leveled')),
